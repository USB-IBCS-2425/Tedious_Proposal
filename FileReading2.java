...
class FileReading2 {
    ...
    public FileReading2() {
        ...
        toRead = new JTextField("Franklin.txt");
        ...
        mostCommonB.setBounds(620, 150, 100, 100);
        ...
        leastCommonB.setBounds(620, 50, 100, 100);
    ...
    private class ButtonClickListener implements ActionListener{
        public void actionPerformed(ActionEvent e) {
            ...
            if (command.equals("MOST_COMMON")) {
                ...
                resultT.setText(Integer.toString(maxFreq));
            }

            if (command.equals("LEAST_COMMON")) {
                ...
                resultT.setText(Integer.toString(minFreq));
            }
